...
import { debounce, listener} from './../helpers';
...
const messages = {
    email: 'Not email',
    minLength: 'This field should contain at least {n} symbols',
    maxLength: 'This field should contain less than {n} symbols',
    required: 'This field is required',
    number: 'This field should contain only numbers',
    listen: 'The Fields should match',
    numbercontain: 'This field should contain at least one number',
    lettercontain: 'This field should contain at least one letter'
};
